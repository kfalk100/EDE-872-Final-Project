...
```{r Line Plot of Species Appearance Over Time, echo=FALSE, fig.align='center', fig.cap="Figure 1. Line Plot of Species Appearance Over Time", warning=FALSE}
Species_over_time <- 
...
```{r Scatter Plot of Ambient Noise Over Time, echo=FALSE, fig.align='center', warning=FALSE, fig.cap="Figure 2. Scatter Plot of Ambient Noise Over Time"}
Noise_over_time <- 
...
```{r Line Plot of Average Ambient Noise, echo=FALSE, fig.align='center', warning=FALSE, fig.cap="Figure 3. Line Plot of Average Ambient Noise" }
AverageAmbientPlot <-
...
```{r Road Noise True or False, echo=FALSE, fig.align='center', fig.cap="Figure 4. Road Noise Presence or Absence Across All Sites"}
RoadNoisePlot <- 
...
```{r Scatter Plot of Hemlock Condition Over Time, echo=FALSE, warning=FALSE, fig.align='center', fig.cap="Figure 5. Scatter Plot of Hemlock Condition Over Time"}
Hemlock_over_time <-
...
```{r / Comparison of Hemlock Condition and Detection Count, echo=FALSE, warning=FALSE, fig.align='center', fig.cap="Figure 6. Comparison of Hemlock Condition and Detection Count"}
HemlockVSDetection <-
...
```{r / Graph Monitoring Sites, echo=FALSE, warning=FALSE}
# Monitoring Sites
...
ExplanatoryVariableMap <- MonitoringSitesNoise + MonitoringSitesHemlock + MonitoringSitesTrue + MonitoringSitesFalse
